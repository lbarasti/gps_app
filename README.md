- This requires ruby 2.0. If you are using debian, this may require a third-party PPA. The package name is usually `ruby2.0`. Use `sudo update-alternatives --config java` to change the ruby version in debian.
